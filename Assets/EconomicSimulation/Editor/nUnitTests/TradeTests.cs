...
public class TradeTests
{
    ...
    {
        var province = new Province("test", 1, null, false);
    ...
    {
        var firstProvince = new Province("first province", 1, null, false);
        var firstCountry = new Country("first", null, Color.black, firstProvince, 10f);

        var secondProvince = new Province("second province", 1, null, false);
