    ...
    public class BattleResult
    {
        ...
        public void createMessage()
        {
            ...
            else if (defender.IsHuman && isDefenderWon())
            {
                ...
                // sb.Append("\nDate is ").Append(Game.date);
                MessageSystem.Instance.NewMessage("We won a battle!", sb.ToString(), "Fine", true, place.provinceMesh.Position);
            }
            else if (attacker.IsHuman && isDefenderWon())
            {
                ...
                // sb.Append("\nDate is ").Append(Game.date);
                MessageSystem.Instance.NewMessage("We lost a battle!", sb.ToString(), "Fine", false, place.provinceMesh.Position);
            }
...

            {
                ...
                // sb.Append("\nDate is ").Append(Game.date);
                MessageSystem.Instance.NewMessage("We lost a battle!", sb.ToString(), "Not fine really", false, place.provinceMesh.Position);
            }
        }
