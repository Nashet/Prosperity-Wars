    ...
    public class PopType : Name, IWayOfLifeChange
    {
        ...
        public List<Storage> getMilitaryNeedsPer1000Men(Country country)
        {
            ...
            foreach (var item in militaryNeeds)
                if (item.Product != Product.Cattle || country.Inventions.IsInvented(Invention.Domestication))
        ...
        {
            if (this == Aristocrats)
                if (targetType == Farmers && Country.Inventions.IsInvented(Invention.Farming)
                    || targetType == Soldiers && Country.Inventions.IsInvented(Invention.ProfessionalArmy)
                ...
                if (targetType == Soldiers && Country.Inventions.IsInvented(Invention.ProfessionalArmy)
             || targetType == Tribesmen
             || targetType == Workers
                )
                    return true;
                ...
                if (targetType == Workers
                    || targetType == Farmers && Country.Inventions.IsInvented(Invention.Farming)
                    || targetType == Soldiers && Country.Inventions.IsInvented(Invention.ProfessionalArmy))
                    return true;
                else
                    return false;
