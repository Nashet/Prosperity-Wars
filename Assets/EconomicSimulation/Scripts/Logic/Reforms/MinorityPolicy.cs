...
namespace Nashet.EconomicSimulation.Reforms
{
    public class MinorityPolicy : AbstractReform
    {
            ...
            new List<IReformValue> { Equality, Residency, NoRights })
        {
            ...
            if (Residency == null)
                Residency = new MinorityPolicyValue("Restricted Rights for Minorities", " - Only state culture can vote, assimilation occurs except foreign core provinces, social benefits go only to state culture", 1, new DoubleConditionsList());
